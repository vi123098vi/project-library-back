...
class ColorDelegatorTest(unittest.TestCase):
    ...
    def test_recolorize_main(self, mock_notify):
        ...
        expected = (
            ...
            ("25.37", ("KEYWORD",)),
            ("26.4", ("KEYWORD",)),
            ("26.9", ("KEYWORD",)),  # ('26.11', ('KEYWORD',)), ('26.14', (),),
            ("27.25", ("STRING",)),
            ("27.38", ("STRING",)),
            ("29.0", ("STRING",)),
            ("30.1", ("STRING",)),
    ...
    def test_def_statement(self):
        ...
        self._assert_highlighting(
            "def foo:", {"KEYWORD": [("1.0", "1.3")], "DEFINITION": [("1.4", "1.7")]}
        )

        # def followed by partial identifier
        self._assert_highlighting(
            "def fo", {"KEYWORD": [("1.0", "1.3")], "DEFINITION": [("1.4", "1.6")]}
        )
    ...
    def test_match_soft_keyword(self):
        ...
        self._assert_highlighting(
            "match int:", {"KEYWORD": [("1.0", "1.5")], "BUILTIN": [("1.6", "1.9")]}
        )
    ...
    def test_case_soft_keyword(self):
        ...
        self._assert_highlighting(
            "case int:", {"KEYWORD": [("1.0", "1.4")], "BUILTIN": [("1.5", "1.8")]}
        )
